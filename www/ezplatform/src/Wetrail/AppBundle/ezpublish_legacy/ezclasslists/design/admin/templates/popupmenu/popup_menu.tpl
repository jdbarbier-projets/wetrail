{*
 * $Id: popup_menu.tpl 14 2009-11-11 21:39:38Z dpobel $
 * $HeadURL: http://svn.projects.ez.no/ezclasslists/tags/ezclasslists_1_2/ezclasslists/design/admin/templates/popupmenu/popup_menu.tpl $
 *}
...
menuArray['ClassMenu']['elements']['class-list']['url'] = {"/classlists/list/%classID%"|ezurl};
