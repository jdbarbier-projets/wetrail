{*
 * $Id: popup_class_menu.tpl 17 2011-06-22 18:50:07Z dpobel $
 * $HeadURL: http://svn.projects.ez.no/ezclasslists/tags/ezclasslists_1_2/ezclasslists/design/admin2/templates/popupmenu/popup_class_menu.tpl $
 *}
<!-- Class popup menu -->
...
{* ezclasslists customization *}
menuArray['ClassMenu']['elements']['class-list'] = {ldelim} 'url': {"/classlists/list/%classID%"|ezurl} {rdelim};
{* /ezclasslists customization *}
...
{/if}
    {* ezclasslists customization *}
    <a id="class-list" href="#" onmouseover="ezpopmenu_mouseOver( 'ClassMenu' )">{"View objects of this class"|i18n("design/admin/popupmenu")}</a>
    {* /ezclasslists customization *}
