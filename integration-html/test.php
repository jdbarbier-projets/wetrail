...
<div id="testProduit" class="zones">
    <div class="container container-full-width header-cover mb-0">
        <div class="opacity-filter light"></div>
        <img class="img-cover" src="images/header-article.jpg" alt="" />
        <div class="testing-infos">
            <span class="infos d-none d-md-block"> 12.05.2019 | Millau, France | Chaussure</span>
            <h1>Test : Altra Lone Peak</h1>
